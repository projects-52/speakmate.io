...
export const EnglishCharacters: Character[] = [
  {
    ...
    personality:
      'Sam is a patient and enthusiastic teacher with a passion for English literature. He is always eager to share interesting facts about the English language and its usage in different literary contexts. He often incorporates his love for nature and photography into his teaching.',
    visual:
  ...
  },
  {
    ...
    personality:
      'Liz is a kind and wise teacher, always ready to share her vast knowledge about the historical aspects of the English language. She likes to relate language learning to her interests, using historical events and cultures to explain language nuances.',
    visual:
  ...
  },
  {
    ...
    personality:
      "Jamie is a dynamic and trendy teacher, incorporating modern slang, music lyrics, and references from pop culture into their lessons. They have a knack for making language learning fun and relevant to today's digital age.",
    visual:
  ...
  },
  {
    ...
    personality:
      'Marty is an engaging and adventurous teacher who loves to explore the intersections of language, technology, and food. He often uses his travel experiences to provide interesting insights into the English language.',
    visual:
  ...
  },
  {
    ...
    personality:
      'Helen is a thoughtful and inspiring teacher with a deep appreciation for art and culture. She loves to explore the connection between language and wellness, often using her hobbies to create interesting and relaxing language lessons.',
    visual:
